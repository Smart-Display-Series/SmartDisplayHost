...
extern touchgfx::GeneratedFont& getFont_Xolonium_Regular_otf_50_4bpp();
extern touchgfx::GeneratedFont& getFont_verdana_10_4bpp();

const touchgfx::Font* _fonts[] =
{
    &(getFont_Xolonium_Regular_otf_50_4bpp()),
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        _fonts[0] = &(getFont_Xolonium_Regular_otf_50_4bpp());
        break;
    case 1:
        _fonts[1] = &(getFont_verdana_10_4bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
